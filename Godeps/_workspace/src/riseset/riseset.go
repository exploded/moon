...
// An Object specifies an astronomical object such as Sun, Moon etc
type Object int
...
/*
Riseset calculates the rise and set time for a given oject, date, location and timezone
...
month := 10       
day := 21        
zone := 11.         // Time zone (East +)
glong := 144.966944 // Longitude (w neg, decimals)
glat := -37.816944  // Latitude  (n pos, decimals)
